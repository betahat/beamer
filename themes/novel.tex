...
\setbeamertemplate{frametitle}
{
  ...
  \begin{beamercolorbox}[sep=1mm,wd=1.01\paperwidth]{frametitle}
    \hfill \tiny \insertsectionhead \hspace{2mm} \par%
...
\setbeamertemplate{navigation symbols}{
  ...
  \ifnum\thepage>1\relax
    \begin{tikzpicture}
      ...
      \fill[fill=Gray] (0,0) circle (2.5mm);
      \fill[fill=Red] (0,0) -- (90:2.5mm) arc (90:90-\the\p/\the\q*360:2.5mm) -- cycle;
